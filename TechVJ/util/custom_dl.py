...
class ByteStreamer:
    ...
    async def get_file_properties(self, id: int, channel_id: int = LOG_CHANNEL) -> FileId:
        """
    ...
    async def generate_file_properties(self, id: int, channel_id: int = LOG_CHANNEL) -> FileId:
        """
